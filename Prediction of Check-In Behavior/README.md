# Prediction of Check-In Behavior for the Restaurant Category 
This project was conducted within the course "Data Science and Marketing Analytics" at Goethe University. 

Goal of the project: Restaurants need to know what internal and external factors drive customer behavior. For that, it is needed to accurately predict whether a consumer will visit a restaurant and to determine the most important variables influencing his behavior.
